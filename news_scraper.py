    ...
    for n in range(2, 6):
        try:
            ...
            if post_ref not in db.keys():
                print(f'{post_title}\n{post_ref}')
                print()
                additional_news += [[post_title, post_ref, 'Fertagus', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRY6izpsx-PgRazEZpx34qbGTe_TqCuFpDfXAxBUydI-IrSSiOUZtqW92agi41Er6YPSqk&usqp=CAU']]
        except:
            pass
    driver.quit()
    if additional_news != []:
